...
describe('Add Broker Intermediary', () => {
  it('Login_SystemAdmin', function() {
    ...
    for (var i = 0; i < 20; i++) {
      ...
      cy.get('.options > :nth-child(2)').click() //Select Intermediary from the dropdown
      ...
      cy.get(':nth-child(12) > .w-full').type(email[0]+i+'bi1@gmail.com') //write email
